...
while True:
   ...
   -------------------------------------------------------------------------"""
    ...
    if len(jerar)==0:
        ...
        jerar.sort()
        print ""
        print "Aparentemente possa ser uma =):"
        print "[+] ",algorithms[jerar[0]]
        print "[+] ",algorithms[jerar[1]]
        print ""
        print "Passou longe de ser uma =( :"
